...
### Цель:
Цель данной работы: Настроить IS-IS в офисе Триада.
...
Здесь я вижу с каким маршрутизатором какой тип взаимодействия, вижу метрики до следующих роутеров, интерфейсы через которые получаю маршруты, а так де в явном виде название маршрутизаторов.
