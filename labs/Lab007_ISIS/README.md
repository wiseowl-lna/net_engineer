...
Для проверки работы динамического протокола ISIS выбрала два маршрутизатора: R23 (у этого роутера есть сосед по зоне) и R26 (он с другимм роутерами находится в разных area). Вывод команды на рисунке 2.
