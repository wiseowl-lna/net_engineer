...
До применения фильтра, проверила какие префиксы прилетают на маршрутизатор Ламас и Киторн (команды **_sh ip bgp_** для IPv4 и **_show bgp ipv6 unicast_** для IPv6). Вывод на рисунке 1 и 2.
