...
4. Настроила маршрутизатор R18 в офисе Санкт Петербург так, чтобы трафик распределялся по двум линкам одновременно. С помощью команды **_maximum-paths \<n>_** указала количество разрешенных маршрутов.
