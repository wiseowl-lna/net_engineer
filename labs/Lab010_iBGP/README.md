...
Для того, что бы изменить значения по умолчанию, можно использовать два варианта: команду bgp default local-preference или route-map. Я выбрала первый вариант.
...
Проверю проходжение трафика после данной настройки. Запустила на маршрутизаторе R14 команду **_sh ip route_**. Результат на рисунке 4а (вывод команды не полный).
