...
**_eBGP (внешний протокол маршрутизации (exterior gateway protocol))__** – протокол, который используется для передачи информации о маршрутах между автономными системами. 
