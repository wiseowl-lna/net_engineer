...
**__Основные характеристики протокола:__**
...
**__eBGP (внешний протокол маршрутизации (exterior gateway protocol))__** – протокол, который используется для передачи информации о маршрутах между автономными системами. 

**__Автономная система (autonomous system, AS)__** — набор маршрутизаторов, имеющих единые правила маршрутизации, управляемых одной технической администрацией и работающих на одном из протоколов IGP (для внутренней маршрутизации AS может использовать и несколько IGP).
