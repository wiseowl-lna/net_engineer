...
Настроила NAT так, что бы маршрутизатор R19 был доступен для управления с любого узла. Для этого необходимо настроить перенаправление портов. Настроики делаются на маршрутизаторах R14 и R15.
