...
---------------------------------------------------------------
    ...
    ip nat pool NAT-MOSKVA 10.1.15.1 10.1.14.1 netmask 255.255.255.252
    !
    ...
    router bgp 1001
     address-family ipv4
      ...
      network 10.1.15.1 mask 255.255.255.255
      # С помощью route-map
...
После настройки, необходимо проверить работу NAT. Использую команды **_sh ip nat translations_**, **_sh ip nat statistics_** и команду **_sh ip nat translations verbose_** для получения расширенной информации(рис.___).
