...
Записала первый IP-адрес (192.168.1.1) в таблицу адресации (Таблица 1) для R1 E0/1.100. Записала второй IP-адрес (192.168.1.2) в таблицу адресов для S1 VLAN 200 и введите соответствующий шлюз по умолчанию.
