...
- Выполнив команду **_show ip dhcp pool_** мы видим, что у нас настроено два пула, видим адреса пулов; видим их адресацию; видим, сколько адресов в пуле. Вывод команды приводится на рисунке 3.
