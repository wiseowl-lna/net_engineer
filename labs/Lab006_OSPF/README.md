...
В данном разделе показано как настроить протокол OSPF. Файлы с настройками протокола OSPF находятся в папке [configs](configs/) в файлах **_---_int.txt_**. Первые символы в названии файлов соответствуют именам сетевых устройств. 
