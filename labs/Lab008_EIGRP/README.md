...
3. Так же с помощью команд **_sh ip route_** и **_sh ipv6 route_** можно проверить наличие маршрутов полученных по протоколу IEGRP.

Для проверки работы динамического протокола EIGRP выбрала несколько устройств: R23 (у этого роутера есть сосед по зоне) и R26 (он с другимм роутерами находится в разных area). Отображение таблиц маршрутизации на R23 с протоколом IPv4 и IPv6 показано на рисунках 5-6.
