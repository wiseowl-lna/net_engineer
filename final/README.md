##  **Создание корпоративной сети передачи данных с организацией безопасных распределенных L2- и L3-связей,
единой точкой выхода и централизованным управлением,
