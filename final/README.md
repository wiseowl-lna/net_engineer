##  **Создание корпоративной сети передачи данных с организацией безопасных распределенных L2- и L3-связей, единой точкой выхода и централизованным управлением,
на базе мультисервисных сетей провайдеров.**
...
3. Организация шифрованного канала для подключения к серверному сегменту![изображение](https://user-images.githubusercontent.com/71774279/109543279-23ac8c00-7ad7-11eb-8a54-a3f886fe5ef1.png)
